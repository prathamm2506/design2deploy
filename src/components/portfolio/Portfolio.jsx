const callouts = [
  {
    ...
    imageAlt:
      "Photography portfolio website displaying various photo galleries.",
    href: "#",
  },
  {
    ...
    imageAlt:
      "Design portfolio featuring various creative projects and case studies.",
    href: "#",
  },
  {
    ...
    imageAlt:
      "Business portfolio showcasing services, testimonials, and project highlights.",
    href: "#",
  },
];
            ...
            {callouts.map((callout) => (
              <div key={callout.name} className="group relative">
                <img
                  ...
                  className="w-full aspect-[16/9] rounded-lg bg-white object-cover group-hover:opacity-75"
                />
