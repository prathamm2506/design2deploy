...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    <h2 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-balance">Insights</h2>
    <p className="mt-6 text-lg/8 text-gray-300">Stay in the know with insights from industry experts.</p>
  </div>
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <a className="group flex flex-col focus:outline-hidden" href="#">
      <div className="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
        ...
        <span className="absolute top-0 end-0 rounded-se-xl rounded-es-xl text-xs font-medium bg-indigo-500 text-white py-1.5 px-3">
          Sponsored
        </span>
      </div>

      <div className="mt-7">
        <h3 className="text-base/7 font-semibold text-white group-hover:text-gray-300">
          Studio by Preline
        </h3>
        <p className="mt-3 text-base/7 text-gray-400">
          Produce professional, reliable streams easily leveraging Preline's innovative broadcast studio
        </p>
        <p className="mt-5 inline-flex items-center gap-x-1 text-sm text-indigo-400 decoration-2 group-hover:underline group-focus:underline font-medium">
          Read more
    ...
    <a className="group relative flex flex-col w-full min-h-60 bg-[url('https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=560&q=80')] bg-center bg-cover rounded-xl hover:shadow-lg focus:outline-hidden focus:shadow-lg transition" href="#">
